...
The macOS app runs your system's own `/usr/bin/ssh` for **both** terminal and
SFTP sessions, so it inherits your existing SSH configuration, keys, and agent —
BHTerminal does not reimplement or bundle its own SSH transport.
